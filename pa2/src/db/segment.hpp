...
class Segment3D {
public:
    Segment3D(int x1 = 0, int y1 = 0, int z1 = 0, int x2 = 0, int y2 = 0, int z2 = 0)
    ...
    int       layer   ()      const   { return min(_p1.layer(), _p2.layer()); }
    int       x1      ()      const   { return _p1[0];                        }
    int       x2      ()      const   { return _p2[0];                        }
    int       y1      ()      const   { return _p1[1];                        }
    int       y2      ()      const   { return _p2[1];                        }
    int       z1      ()      const   { return _p1.layer();                   }
    int       z2      ()      const   { return _p2.layer();                   }
    int       length  ()      const   { return Point3D::Mdistance(_p1, _p2);  }
    ...
    int&       operator[] (const int& i)      { if(i == 0)        return _p1[0];
    ...
    const int& operator[] (const int& i) const{ if(i == 0)        return _p1[0];
                                                  else if (i == 1)  return _p1[1];
                                                  else if (i == 2)  return _p1[2];
                                                  else if (i == 3)  return _p2[0];
                                                  else if (i == 4)  return _p2[1];
